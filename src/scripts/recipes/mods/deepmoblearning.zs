...
static shapedRecipes as IIngredient[][][][IItemStack] = {
    ...
    <deepmoblearning:machine_casing> : [
			[
	  			...
	  			[<deepmoblearning:soot_covered_plate>n <ore:ingotIron>, <deepmoblearning:soot_covered_plate>]
			]
	],
    <deepmoblearning:deep_learner> : [
			[
	  			...
	  			[<deepmoblearning:soot_covered_plate>n <deepmoblearning:soot_covered_redstone>, <deepmoblearning:soot_covered_plate>]
			]
	]
